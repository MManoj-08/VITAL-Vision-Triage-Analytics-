...
# image-to-text, reasoning, text-to-text, tool calling
...
DEFAULT_QUESTION = "Explain me about something unique about machine learning which no one knows or tells."
...
def main() -> None:
    ...
    for chunk in completion:
        ...
        if reasoning:
            ...
            full_output_parts.append(reasoning)
